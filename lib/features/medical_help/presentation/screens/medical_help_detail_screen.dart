...
import 'package:flutter_application_military_directory/features/medical_help/presentation/widgets/stage_card.dart';
import 'stage_detail_screen.dart';

class MedicalHelpDetailScreen extends StatelessWidget {
  ...
  Widget _buildStageGrid() {
    // Используем только заполненные этапы
    final stages = med.filledStages;
    return Padding(
          ...
          return StageCard(
            ...
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (_) =>
                      StageDetailScreen(medTitle: med.title, stage: stage),
                ),
              );
            },
          );
